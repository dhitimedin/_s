            ...
            <?php 
                if ( have_posts() ) :
                    while ( have_posts() ) :
                        the_post();
            ?>
                        <h2 class="spi-card-title text-uppercase text-left my-3"><strong><?php echo get_the_title(); ?></strong></h2>
                        <!--Section description-->

                        <p class="text-left spi-card-text mx-auto mb-4">
                            <?php echo "All fields marked with (*) are mandatory"; ?>
                        </p>
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-md-6 pb-4">
                                <p>
                                    ...
                                    <a href="tel:+91-124-4692015" class="text-decoration-none text-white">+91-124-4692015 </a>
                                </p>
