            ...
            <footer id="colophon" class="site-footer">
                ...
                <div class="row mx-2" style="z-index: 2">
                    ...
                    <div class="footer-lower">
                        ...
                        <a class="text-primary text-decoration-none" href="<?php echo esc_url( __( 'mailto:contact@smartpowerindia.org', '_s' ) ); ?>">
                            <!-- translators: %s: CMS name, i.e. WordPress. -->
                            <?php echo esc_html__( 'contact@smartpowerindia.org', '_s' ); ?>
                        </a>
                    </div>
                </div>
                <!--Copyright-->
