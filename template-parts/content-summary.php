        ...
        $main_banner = $main_banner
                .'<div class="spi-card-container">'
                    ...
                    . '<div class="' . ((in_array($post->post_name, 
                        ...
                        . '<h2 class="home-card-header"><strong>' . get_the_title() . '</strong></h2>'
                        . '<p class="' . ((($wp_query->get_queried_object())->post_name == "careers") ? 'spi-card-text': 'home-card-text') . '">' . get_the_post_thumbnail_caption() . '</p>'
                    . '</div>'
                . '</div>';                     
        echo $main_banner;
    }
