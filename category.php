                ...
                <div class="spi-card-hover">
                    <?php if ( strpos($post->post_content, "</iframe>" ) 
                        ...
                        <div class="spi-res-video-container">
                            <iframe src="<?php echo simplexml_load_string( get_the_content() )->attributes()->{'src'}; ?>" 
                                frameborder="0" allowfullscreen class="responsive-iframe" loading="lazy"></iframe>
                        </div> 
